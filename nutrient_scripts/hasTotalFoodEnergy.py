...
def calculate_FoodEnergy_for_salad(g, salad_name):
    ...
    nutrient_property = S.hasTotalFoodEnergy
...
def process_salads():
    ...
    for r in g.query(q):
        ...
        calculate_FoodEnergy_for_salad(g, n)
