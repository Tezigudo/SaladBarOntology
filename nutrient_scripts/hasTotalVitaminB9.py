...
def calculate_VitaminB9_for_salad(g, salad_name):
    ...
    nutrient_property = S.hasTotalVitaminB9
...
def process_salads():
    ...
    for r in g.query(q):
        ...
        calculate_VitaminB9_for_salad(g, n)
