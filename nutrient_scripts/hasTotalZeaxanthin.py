...
def calculate_Zeaxanthin_for_salad(g, salad_name):
    ...
    nutrient_property = S.hasTotalZeaxanthin
...
def process_salads():
    ...
    for r in g.query(q):
        ...
        calculate_Zeaxanthin_for_salad(g, n)
