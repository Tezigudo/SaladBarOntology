...
def calculate_Cholesterol_for_salad(g, salad_name):
    ...
    nutrient_property = S.hasTotalCholesterol
...
def process_salads():
    ...
    for r in g.query(q):
        ...
        calculate_Cholesterol_for_salad(g, n)
