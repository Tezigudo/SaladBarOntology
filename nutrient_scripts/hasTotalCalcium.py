...
def calculate_Calcium_for_salad(g, salad_name):
    ...
    nutrient_property = S.hasTotalCalcium
...
def process_salads():
    ...
    for r in g.query(q):
        ...
        calculate_Calcium_for_salad(g, n)
