...
def calculate_VitaminA_for_salad(g, salad_name):
    ...
    nutrient_property = S.hasTotalVitaminA
...
def process_salads():
    ...
    for r in g.query(q):
        ...
        calculate_VitaminA_for_salad(g, n)
