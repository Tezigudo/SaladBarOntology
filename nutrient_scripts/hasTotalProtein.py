...
def calculate_Protein_for_salad(g, salad_name):
    ...
    nutrient_property = S.hasTotalProtein
...
def process_salads():
    ...
    for r in g.query(q):
        ...
        calculate_Protein_for_salad(g, n)
