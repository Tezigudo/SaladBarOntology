...
def calculate_Potassium_for_salad(g, salad_name):
    ...
    nutrient_property = S.hasTotalPotassium
...
def process_salads():
    ...
    for r in g.query(q):
        ...
        calculate_Potassium_for_salad(g, n)
