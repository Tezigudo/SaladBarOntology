...
def calculate_VitaminC_for_salad(g, salad_name):
    ...
    nutrient_property = S.hasTotalVitaminC
...
def process_salads():
    ...
    for r in g.query(q):
        ...
        calculate_VitaminC_for_salad(g, n)
