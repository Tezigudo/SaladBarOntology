...
def calculate_Omega-3_for_salad(g, salad_name):
    ...
    nutrient_property = S.hasTotalOmega_3
...
def process_salads():
    ...
    for r in g.query(q):
        ...
        calculate_Omega-3_for_salad(g, n)
