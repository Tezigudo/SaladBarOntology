...
def calculate_Lutein_for_salad(g, salad_name):
    ...
    nutrient_property = S.hasTotalLutein
...
def process_salads():
    ...
    for r in g.query(q):
        ...
        calculate_Lutein_for_salad(g, n)
