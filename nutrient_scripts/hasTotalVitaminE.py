...
def calculate_VitaminE_for_salad(g, salad_name):
    ...
    nutrient_property = S.hasTotalVitaminE
...
def process_salads():
    ...
    for r in g.query(q):
        ...
        calculate_VitaminE_for_salad(g, n)
