...
def calculate_Sodium_for_salad(g, salad_name):
    ...
    nutrient_property = S.hasTotalSodium
...
def process_salads():
    ...
    for r in g.query(q):
        ...
        calculate_Sodium_for_salad(g, n)
