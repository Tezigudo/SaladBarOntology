...
# Constant for Cholesterol unit
CHOLESTEROL_UNIT = "mg/100g"

# Constant for Cholesterol property
CHOLESTEROL_PROPERTY = S.hasTotalCholesterol

def calculate_nutrient_for_salad(g, salad_name, nutrient_name="Cholesterol", unit=CHOLESTEROL_UNIT, property=CHOLESTEROL_PROPERTY):
    """
    Calculate total amount for Cholesterol for a given salad and update or create SaladSubstance instances.
    
    Args:
        g (Graph): The RDF graph to work with
        salad_name (str): Name of the salad instance (e.g., 'CapreseSalad')
        nutrient_name (str): Name of the nutrient to calculate (default: 'Cholesterol')
        unit (str): Unit for the nutrient (default: 'mg/100g')
        property (URIRef): Property for the nutrient (default: hasTotalCholesterol)
    """
...
def process_all_salads_for_nutrient(nutrient_name="Cholesterol", unit=CHOLESTEROL_UNIT, property=CHOLESTEROL_PROPERTY):
    """
    Retrieve all Salad instances and calculate their total for a specific nutrient (Cholesterol).
...
if __name__ == "__main__":
    process_all_salads_for_nutrient("Cholesterol", CHOLESTEROL_UNIT, CHOLESTEROL_PROPERTY)
