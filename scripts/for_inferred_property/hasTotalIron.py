...
# Constant for Iron unit
IRON_UNIT = "mg/100g"

# Constant for Iron property
IRON_PROPERTY = S.hasTotalIron

def calculate_nutrient_for_salad(g, salad_name, nutrient_name="Iron", unit=IRON_UNIT, property=IRON_PROPERTY):
    """
    Calculate total amount for Iron for a given salad and update or create SaladSubstance instances.
    
    Args:
        g (Graph): The RDF graph to work with
        salad_name (str): Name of the salad instance (e.g., 'CapreseSalad')
        nutrient_name (str): Name of the nutrient to calculate (default: 'Iron')
        unit (str): Unit for the nutrient (default: 'mg/100g')
        property (URIRef): Property for the nutrient (default: hasTotalIron)
    """
...
def process_all_salads_for_nutrient(nutrient_name="Iron", unit=IRON_UNIT, property=IRON_PROPERTY):
    """
    Retrieve all Salad instances and calculate their total for a specific nutrient (Iron).
...
if __name__ == "__main__":
    process_all_salads_for_nutrient("Iron", IRON_UNIT, IRON_PROPERTY)
