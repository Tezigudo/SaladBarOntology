...
# Constant for VitaminA unit
VITAMINA_UNIT = "mg/100g"

# Constant for VitaminA property
VITAMINA_PROPERTY = S.hasTotalVitaminA

def calculate_nutrient_for_salad(g, salad_name, nutrient_name="VitaminA", unit=VITAMINA_UNIT, property=VITAMINA_PROPERTY):
    """
    Calculate total amount for VitaminA for a given salad and update or create SaladSubstance instances.
    
    Args:
        g (Graph): The RDF graph to work with
        salad_name (str): Name of the salad instance (e.g., 'CapreseSalad')
        nutrient_name (str): Name of the nutrient to calculate (default: 'VitaminA')
        unit (str): Unit for the nutrient (default: 'mg/100g')
        property (URIRef): Property for the nutrient (default: hasTotalVitaminA)
    """
...
def process_all_salads_for_nutrient(nutrient_name="VitaminA", unit=VITAMINA_UNIT, property=VITAMINA_PROPERTY):
    """
    Retrieve all Salad instances and calculate their total for a specific nutrient (VitaminA).
...
if __name__ == "__main__":
    process_all_salads_for_nutrient("VitaminA", VITAMINA_UNIT, VITAMINA_PROPERTY)
