...
# Constant for Omega-3 unit
OMEGA-3_UNIT = "mg/100g"

# Constant for Omega-3 property
OMEGA-3_PROPERTY = S.hasTotalOmega_3

def calculate_nutrient_for_salad(g, salad_name, nutrient_name="Omega-3", unit=OMEGA-3_UNIT, property=OMEGA-3_PROPERTY):
    """
    Calculate total amount for Omega-3 for a given salad and update or create SaladSubstance instances.
    
    Args:
        g (Graph): The RDF graph to work with
        salad_name (str): Name of the salad instance (e.g., 'CapreseSalad')
        nutrient_name (str): Name of the nutrient to calculate (default: 'Omega-3')
        unit (str): Unit for the nutrient (default: 'mg/100g')
        property (URIRef): Property for the nutrient (default: hasTotalOmega_3)
    """
...
def process_all_salads_for_nutrient(nutrient_name="Omega-3", unit=OMEGA-3_UNIT, property=OMEGA-3_PROPERTY):
    """
    Retrieve all Salad instances and calculate their total for a specific nutrient (Omega-3).
...
if __name__ == "__main__":
    process_all_salads_for_nutrient("Omega-3", OMEGA-3_UNIT, OMEGA-3_PROPERTY)
