...
# Constant for VitaminC unit
VITAMINC_UNIT = "mg/100g"

# Constant for VitaminC property
VITAMINC_PROPERTY = S.hasTotalVitaminC

def calculate_nutrient_for_salad(g, salad_name, nutrient_name="VitaminC", unit=VITAMINC_UNIT, property=VITAMINC_PROPERTY):
    """
    Calculate total amount for VitaminC for a given salad and update or create SaladSubstance instances.
    
    Args:
        g (Graph): The RDF graph to work with
        salad_name (str): Name of the salad instance (e.g., 'CapreseSalad')
        nutrient_name (str): Name of the nutrient to calculate (default: 'VitaminC')
        unit (str): Unit for the nutrient (default: 'mg/100g')
        property (URIRef): Property for the nutrient (default: hasTotalVitaminC)
    """
...
def process_all_salads_for_nutrient(nutrient_name="VitaminC", unit=VITAMINC_UNIT, property=VITAMINC_PROPERTY):
    """
    Retrieve all Salad instances and calculate their total for a specific nutrient (VitaminC).
...
if __name__ == "__main__":
    process_all_salads_for_nutrient("VitaminC", VITAMINC_UNIT, VITAMINC_PROPERTY)
