...
# Constant for Sodium unit
SODIUM_UNIT = "mg/100g"

# Constant for Sodium property
SODIUM_PROPERTY = S.hasTotalSodium

def calculate_nutrient_for_salad(g, salad_name, nutrient_name="Sodium", unit=SODIUM_UNIT, property=SODIUM_PROPERTY):
    """
    Calculate total amount for Sodium for a given salad and update or create SaladSubstance instances.
    
    Args:
        g (Graph): The RDF graph to work with
        salad_name (str): Name of the salad instance (e.g., 'CapreseSalad')
        nutrient_name (str): Name of the nutrient to calculate (default: 'Sodium')
        unit (str): Unit for the nutrient (default: 'mg/100g')
        property (URIRef): Property for the nutrient (default: hasTotalSodium)
    """
...
def process_all_salads_for_nutrient(nutrient_name="Sodium", unit=SODIUM_UNIT, property=SODIUM_PROPERTY):
    """
    Retrieve all Salad instances and calculate their total for a specific nutrient (Sodium).
...
if __name__ == "__main__":
    process_all_salads_for_nutrient("Sodium", SODIUM_UNIT, SODIUM_PROPERTY)
