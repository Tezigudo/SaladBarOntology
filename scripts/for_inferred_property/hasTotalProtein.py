...
# Constant for Protein unit
PROTEIN_UNIT = "mg/100g"

# Constant for Protein property
PROTEIN_PROPERTY = S.hasTotalProtein

def calculate_nutrient_for_salad(g, salad_name, nutrient_name="Protein", unit=PROTEIN_UNIT, property=PROTEIN_PROPERTY):
    """
    Calculate total amount for Protein for a given salad and update or create SaladSubstance instances.
    
    Args:
        g (Graph): The RDF graph to work with
        salad_name (str): Name of the salad instance (e.g., 'CapreseSalad')
        nutrient_name (str): Name of the nutrient to calculate (default: 'Protein')
        unit (str): Unit for the nutrient (default: 'mg/100g')
        property (URIRef): Property for the nutrient (default: hasTotalProtein)
    """
...
def process_all_salads_for_nutrient(nutrient_name="Protein", unit=PROTEIN_UNIT, property=PROTEIN_PROPERTY):
    """
    Retrieve all Salad instances and calculate their total for a specific nutrient (Protein).
...
if __name__ == "__main__":
    process_all_salads_for_nutrient("Protein", PROTEIN_UNIT, PROTEIN_PROPERTY)
