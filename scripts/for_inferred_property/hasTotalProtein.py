...
def update_nutrient_for_salad(g, salad_name, nutrient_name=NUTRIENT_NAME):
    ...
    Args:
        ...
        nutrient_name (str): Name of the nutrient to update (default: 'Protein')
    """
    ...
    for row in results:
        ...
        for sub_row in substance_results:
            ...
            if substance_name != nutrient_name:  # Only process Protein
                continue
...
def process_all_salads_for_nutrient(nutrient_name=NUTRIENT_NAME):
    """
    Retrieve all Salad instances and update their total for a specific nutrient (Protein).
