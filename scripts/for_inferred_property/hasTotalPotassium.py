...
# Constant for Potassium unit
POTASSIUM_UNIT = "mg/100g"

# Constant for Potassium property
POTASSIUM_PROPERTY = S.hasTotalPotassium

def calculate_nutrient_for_salad(g, salad_name, nutrient_name="Potassium", unit=POTASSIUM_UNIT, property=POTASSIUM_PROPERTY):
    """
    Calculate total amount for Potassium for a given salad and update or create SaladSubstance instances.
    
    Args:
        g (Graph): The RDF graph to work with
        salad_name (str): Name of the salad instance (e.g., 'CapreseSalad')
        nutrient_name (str): Name of the nutrient to calculate (default: 'Potassium')
        unit (str): Unit for the nutrient (default: 'mg/100g')
        property (URIRef): Property for the nutrient (default: hasTotalPotassium)
    """
...
def process_all_salads_for_nutrient(nutrient_name="Potassium", unit=POTASSIUM_UNIT, property=POTASSIUM_PROPERTY):
    """
    Retrieve all Salad instances and calculate their total for a specific nutrient (Potassium).
...
if __name__ == "__main__":
    process_all_salads_for_nutrient("Potassium", POTASSIUM_UNIT, POTASSIUM_PROPERTY)
